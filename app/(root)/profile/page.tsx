...
export default function UserProfileForm({ params }: { params: paramsType }) {
  ...
  useEffect(() => {
    ...
    params.then((data) => {
      ...
      setFormData({
        ...
        hasChildren: profile?.hasChildren === true ? 'true' : 
                     profile?.hasChildren === false ? 'false' : '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const formattedData = {
        ...formData,
        age: formData.age || undefined, // Keep age as a string
        hasChildren: formData.hasChildren === "true" ? "true" : 
                     formData.hasChildren === "false" ? "false" : undefined,
